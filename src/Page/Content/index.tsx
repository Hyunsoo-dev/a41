...
const Content = () => {
  ...
  console.log("document.body.scrollHeight :", document.documentElement.scrollHeight - document.documentElement.clientHeight);
  ...
  return (
    <div className="content-page-container">
      <div className="content-page-wrapper">
        ...
        <span className="content-page-progress-bar" style={{ width: `${(scrollPosition / height) * 100}%` }}></span>
