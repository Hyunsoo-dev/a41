...
const OurThesis = () => {
    ...
    return ( <div className={scrollY >= 528 ? "container_img background_action1" : "container_img"}>
            <div className="content-box">
                <div ref={titleRef} className={"title_box"}
                     style={scrollY > 785 ? innerWidth > 375 ? {top: `${300 - (scrollY - 645 - (divTop as number))}px`} : {top: `${160 - (scrollY - 633 - (divTop as number))}px`} : {}}>
                ...
                <div
                    ...
                    style={scrollY > 785 ? innerWidth > 375 ? {top: `${500 - (scrollY - 645 - (divTop as number))}px`} : {top: `${350 - (scrollY - 633 - (divTop as number))}px`} : {}}>
